...
def run_agentic_grounded(ticker: str, worker: ModelConfig, *, judge_model: ModelConfig,
    ...
    if missing:
        return DesignResult(design="agentic_grounded", worker_model=worker.model_id,
    ...
    return DesignResult(
        design="agentic_grounded", worker_model=worker.model_id, company=ticker.upper(),
